...
// Verification Section Ends
  ...
  // CHILDCATEGORY SECTION ENDS------------
    ...
    Route::get('/subchildcategory/datatables', 'Admin\SubChildCategoryControlller@datatables')->name('admin-subchildcat-datatables'); //JSON REQUEST
    Route::get('/subchildcategory', 'Admin\SubChildCategoryControlller@index')->name('admin-subchildcat-index');
    Route::get('/subchildcategory/create', 'Admin\SubChildCategoryControlller@create')->name('admin-subchildcat-create');
    Route::post('/subchildcategory/create', 'Admin\SubChildCategoryControlller@store')->name('admin-childcat-store');
    Route::get('/subchildcategory/edit/{id}', 'Admin\SubChildCategoryControlller@edit')->name('admin-subchildcat-edit');
    Route::post('/subchildcategory/edit/{id}', 'Admin\SubChildCategoryControlller@update')->name('admin-subchildcat-update');
    Route::get('/subchildcategory/delete/{id}', 'Admin\SubChildCategoryControlller@destroy')->name('admin-subchildcat-delete');
    Route::get('/subchildcategory/status/{id1}/{id2}', 'Admin\SubChildCategoryControlller@status')->name('admin-subchildcat-status');
    Route::get('/load/subchildcategories/{id}/', 'Admin\SubChildCategoryControlller@load')->name('admin-subchildcat-load'); //JSON REQUEST
...
// User Orders
  ...
  Route::post('/order/accept', 'User\OrderController@accept')->name('accept_order_user');
...
Route::prefix('vendor')->group(function() {
  ...
  Route::get('/order/{id}/confirm', 'Vendor\OrderController@confirm')->name('vendor-confirm-order');
...
// ************************************ FRONT SECTION **********************************************
  ...
  Route::post('/myFatoorah', 'Front\MyFatoorahController@store')->name('myfatoorah.submit');
  Route::post('/post-paid', 'Front\PostPaidController@store')->name('post_paid.submit');
  Route::get('/myFatoorah/return', 'Front\MyFatoorahController@payreturn')->name('myfatoorah.payment.return');
  Route::get('/myFatoorah/cancle', 'Front\MyFatoorahController@paycancle')->name('myFatoorah.payment.cancle');
