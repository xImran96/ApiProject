...
@php 
  ...
  if(App\Models\Order::where('order_number','=',$order->order->order_number)->first() != null){
...
@endphp
                                      ...
                                      <td>
                                        ...
                                        @if($order->order->method == "post_paid")
                                        <td><a href="{{asset('assets/vendor/contract/contract.pdf')}}" download="Contract"><i class="fa fa-download" aria-hidden="true"></i></a></td>
                                         @endif
                                                  </tr>
